...
import 'maker_tags.dart' show MakerTag, MakerTagFunc, MakerTagsWithName;
import 'tags_base.dart';
...
class StandardTags extends TagsBase {
  ...
  static final Map<int, MakerTag> tags = {
    ...
    0xC615: _make('LocalizedCameraModel'),
    0xC616: _make('CFAPlaneColor'),
    0xC617: _make('CFALayout'),
    0xC618: _make('LinearizationTable'),
    0xC619: _make('BlackLevelRepeatDim'),
    0xC61A: _make('BlackLevel'),
    0xC61B: _make('BlackLevelDeltaH'),
    0xC61C: _make('BlackLevelDeltaV'),
    0xC61D: _make('WhiteLevel'),
    0xC61E: _make('DefaultScale'),
    0xC61F: _make('DefaultCropOrigin'),
    0xC620: _make('DefaultCropSize'),
    0xC621: _make('ColorMatrix1'),
    0xC622: _make('ColorMatrix2'),
    0xC623: _make('CameraCalibration1'),
    0xC624: _make('CameraCalibration2'),
    0xC625: _make('ReductionMatrix1'),
    0xC626: _make('ReductionMatrix2'),
    0xC627: _make('AnalogBalance'),
    0xC628: _make('AsShotNeutral'),
    0xC629: _make('AsShotWhiteXY'),
    0xC62A: _make('BaselineExposure'),
    0xC62B: _make('BaselineNoise'),
    0xC62C: _make('BaselineSharpness'),
    0xC62D: _make('BayerGreenSplit'),
    0xC62E: _make('LinearResponseLimit'),
    0xC62F: _make('CameraSerialNumber'),
    0xC630: _make('DNGLensInfo'),
    0xC631: _make('ChromaBlurRadius'),
    0xC632: _make('AntiAliasStrength'),
    0xC633: _make('ShadowScale'),
    0xC634: _make('DNGPrivateData'),
    0xC635: _make('MakerNoteSafety'),
    0xC640: _make('RawImageSegmentation'),
    0xC65A: _make('CalibrationIlluminant1'),
    0xC65B: _make('CalibrationIlluminant2'),
    0xC65C: _make('BestQualityScale'),
    0xC65D: _make('RawDataUniqueID'),
    0xC68B: _make('OriginalRawFileName'),
    0xC68C: _make('OriginalRawFileData'),
    0xC68D: _make('ActiveArea'),
    0xC68E: _make('MaskedAreas'),
    0xC68F: _make('AsShotICCProfile'),
    0xC690: _make('AsShotPreProfileMatrix'),
    0xC691: _make('CurrentICCProfile'),
    0xC692: _make('CurrentPreProfileMatrix'),
    0xC6BF: _make('ColorimetricReference'),
    0xC6F3: _make('CameraCalibrationSignature'),
    0xC6F4: _make('ProfileCalibrationSignature'),
    0xC6F5: _make('ExtraCameraProfiles'),
    0xC6F6: _make('AsShotProfileName'),
    0xC6F7: _make('NoiseReductionApplied'),
    0xC6F8: _make('ProfileName'),
    0xC6F9: _make('ProfileHueSatMapDims'),
    0xC6FA: _make('ProfileHueSatMapData1'),
    0xC6FB: _make('ProfileHueSatMapData2'),
    0xC6FC: _make('ProfileToneCurve'),
    0xC6FD: _make('ProfileEmbedPolicy'),
    0xC6FE: _make('ProfileCopyright'),
    0xC714: _make('ForwardMatrix1'),
    0xC715: _make('ForwardMatrix2'),
    0xC716: _make('PreviewApplicationName'),
    0xC717: _make('PreviewApplicationVersion'),
    0xC718: _make('PreviewSettingsName'),
    0xC719: _make('PreviewSettingsDigest'),
    0xC71A: _make('PreviewColorSpace'),
    0xC71B: _make('PreviewDateTime'),
    0xC71C: _make('RawImageDigest'),
    0xC71D: _make('OriginalRawFileDigest'),
    0xC71E: _make('SubTileBlockSize'),
    0xC71F: _make('RowInterleaveFactor'),
    0xC725: _make('ProfileLookTableDims'),
    0xC726: _make('ProfileLookTableData'),
    0xC740: _make('OpcodeList1'),
    0xC741: _make('OpcodeList2'),
    0xC74E: _make('OpcodeList3'),
    0xC761: _make('NoiseProfile'),
    0xC763: _make('TimeCodes'),
    0xC764: _make('FrameRate'),
    0xC772: _make('TStop'),
    0xC789: _make('ReelName'),
    0xC7A1: _make('CameraLabel'),
    0xC791: _make('OriginalDefaultFinalSize'),
    0xC792: _make('OriginalBestQualityFinalSize'),
    0xC793: _make('OriginalDefaultCropSize'),
    0xC7A3: _make('ProfileHueSatMapEncoding'),
    0xC7A4: _make('ProfileLookTableEncoding'),
    0xC7A5: _make('BaselineExposureOffset'),
    0xC7A6: _make('DefaultBlackRender'),
    0xC7A7: _make('NewRawImageDigest'),
    0xC7A8: _make('RawToPreviewGain'),
    0xC7B5: _make('DefaultUserCrop'),
    0xC7E9: _make('DepthFormat'),
    0xC7EA: _make('DepthNear'),
    0xC7EB: _make('DepthFar'),
    0xC7EC: _make('DepthUnits'),
    0xC7ED: _make('DepthMeasureType'),
    0xC7EE: _make('EnhanceParams'),
    0xCD2D: _make('ProfileGainTableMap'),
    0xCD2E: _make('SemanticName'),
    0xCD30: _make('SemanticInstanceID'),
    0xCD31: _make('CalibrationIlluminant3'),
    0xCD32: _make('CameraCalibration3'),
    0xCD33: _make('ColorMatrix3'),
    0xCD34: _make('ForwardMatrix3'),
    0xCD35: _make('IlluminantData1'),
    0xCD36: _make('IlluminantData2'),
    0xCD37: _make('IlluminantData3'),
    0xCD38: _make('MaskSubArea'),
    0xCD39: _make('ProfileHueSatMapData3'),
    0xCD3A: _make('ReductionMatrix3'),
    0xCD3B: _make('RGBTables'),
    0xCD40: _make('ProfileGainTableMap2'),
    0xCD43: _make('ColumnInterleaveFactor'),
    0xCD44: _make('ImageSequenceInfo'),
    0xCD46: _make('ImageStats'),
    0xCD47: _make('ProfileDynamicRange'),
    0xCD48: _make('ProfileGroupName'),
    0xCD49: _make('JXLDistance'),
    0xCD4A: _make('JXLEffort'),
    0xCD4B: _make('JXLDecodeSpeed'),
